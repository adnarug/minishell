...
/*   Updated: 2022/10/26 18:46:19 by fnieves-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// static void print_array (char **array_words)
// {
...
static int	count_words(char *str)
{
	...
	while (str[i])
	{
		if (!ft_ismeta(str[i]) && (!(str[i + 1]) || ft_ismeta(str[i + 1])))
		{
			number_words++;
			i--;
		} //importante 
	...
	printf("numero de palabras que encuentra %i\n", number_words);
	return (number_words);
...
// while (string[i] != '\0')
// {
// 	if (ft_strchr(separators, string[i]) == 1)
// 		return (&s[i]);
// 	i++;
// }
// }